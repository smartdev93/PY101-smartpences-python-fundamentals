...
class DialogDemo(Frame):
    ...
    def _info(self):
        tkMessageBox.showinfo(message = "This is a nice day",
                              parent = self)

    def _error(self):
        tkMessageBox.showerror(message = "This is an error",
                               parent = self)

    def _warning(self):
        tkMessageBox.showwarning(message = "This is a warning",
                                 parent = self)

    def _yesno(self):
        tkMessageBox.askyesno(message = "Is it a nice day?",
                              parent = self)
